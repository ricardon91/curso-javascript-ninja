(function () {
    ...
    */
    function isOperatorValid(opMath) {
        return operation[opMath] !== undefined;
    }
    ...
    */
    function calculator(opMath) {
        if (isOperatorValid(opMath) !== true) {
            return false;
        } else {
            return function (num1, num2) {
                if (typeof num1 !== 'number' || typeof num2 !== 'number') {
                    ...
                    return operation[opMath](num1, num2);
                }
            }
        }
    }
    ...
    */
    function showOperationMessage(opMath, num1, num2) {
        return 'A operação ' + num1 + ' ' + opMath + ' ' + num2 + ' =';
    }
    ...
    */
    function showErrorMessage(opMath) {
        return 'Operação ' + opMath + ' não permitida!';
    }
